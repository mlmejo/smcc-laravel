  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ route('competencies.learningOutcomes.store', $competency) }}" method="post" id="createLearningOutcomeForm">
          @csrf
      ...
      <div class="modal fade" id="editlearningOutcomeModal{{ $learningOutcome->id }}" tabindex="-1" aria-labelledby="editlearningOutcomeModal{{ $learningOutcome->id }}Label" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="{{ route('learningOutcomes.update', $learningOutcome) }}" method="post" id="learningOutcomeUpdateForm{{ $learningOutcome->id }}">
                @csrf
                @method('PUT')
      ...
      <div class="modal fade" id="deletelearningOutcomeModal{{ $learningOutcome->id }}" tabindex="-1" aria-labelledby="deletelearningOutcomeModal{{ $learningOutcome->id }}Label" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="{{ route('learningOutcomes.destroy', $learningOutcome) }}" method="post" id="deletelearningOutcomeForm{{ $learningOutcome->id }}">
                @csrf
                @method('DELETE')
                <p class="mb-0">
